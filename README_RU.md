...
# Antigravity Manager — Форк Stranmor
...
**Antigravity Manager** — высокопроизводительный AI-шлюз, который преобразует веб-сессии Google и Anthropic в стандартизированные OpenAI-совместимые API.

Этот форк переработан для **headless-развёртывания на серверах** и **максимальной отказоустойчивости**, уходя от ограничений десктопного приложения к production-ready решению.

## 🎯 Зачем этот форк?

[Upstream-проект](https://github.com/lbjlaq/Antigravity-Manager) — отличное десктопное приложение. Этот форк создан для разработчиков, которым нужен **headless-демон** для работы на VPS, в Docker или как фоновый сервис с enterprise-уровнем стабильности.

### Ключевые отличия

| Функция | Upstream | Форк Stranmor |
|---------|----------|---------------|
...
Форк [lbjlaq/Antigravity-Manager](https://github.com/lbjlaq/Antigravity-Manager). Благодарность оригинальным авторам за концепцию.
