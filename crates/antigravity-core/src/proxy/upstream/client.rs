...
impl UpstreamClient {
    ...
    // Note: call_v1_internal_with_retry method was removed
    // It provided 429 retry logic with async closures for credential rotation.

    // Note: parse_retry_delay and parse_duration_ms helper methods were also removed.
